...
<div class="wrapper">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{URL::asset("assets/dist/img/user3-128x128.jpg")}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{URL::asset("assets/dist/img/user4-128x128.jpg")}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('admin/socialmedia') }}"><i class="fa fa-circle-o"></i> Social Media </a></li>
                        <li class="active"><a href="{{url('/admin/listnews')}}"><i class="fa fa-circle-o"></i>  News Media </a></li>
                    </ul>
                </li>
                <li class="active treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/admin/socialsetting') }}"><i class="fa fa-circle-o"></i> Social setting</a></li>
                        <li class="active"><a href="{{url('/admin/newssetting')}}"><i class="fa fa-circle-o"></i> News setting</a></li>
                    </ul>
                </li>
                    </a>
                    <ul class="treeview-menu">
    ...
    <footer class="main-footer">
        ...
        <strong> start-2017 <a href="#">InshortNews adminPage</a>.</strong> All rights
        reserved.
    </footer>
